          ...
          <Grid item xs={12}>
            <Grid container>
              ...
              <Grid item xs={12}>
                <h2>
                  {" "}
                  {character.race} {character.class_type} Level{" "}
                  {character.level}
                </h2>
              </Grid>
            </Grid>
            ...
            <Grid container justify="center">
              ...
              <Grid item xs={3}>
                ...
                <p>
                  +
                  {Math.floor(
                    (character.dexterity - 10) / 2 + character.proficiency
                  )}
                </p>
              </Grid>
              <Grid xs={7}>
          ...
          <Grid item xs={12}>
            ...
            <Grid container justify="center">
              ...
              <Grid item xs={3}>
                ...
                <p>
                  {proficiencies.includes("ani")
                    ? Math.floor(
                        (character.wisdom - 10) / 2 + character.proficiency
                      )
              ...
              <Grid item xs={3}>
                <h4>Arcana</h4>
                <p>
                  {proficiencies.includes("arc")
                    ? Math.floor(
                        (character.intelligence - 10) / 2 +
              ...
              <Grid item xs={3}>
                <h4>Athletics</h4>
                <p>
                  {proficiencies.includes("ath")
                    ? Math.floor(
                        (character.strength - 10) / 2 + character.proficiency
                      )
              ...
              <Grid item xs={3}>
                <h4>Deception</h4>
                <p>
                  {proficiencies.includes("dece")
                    ? Math.floor(
                        (character.charisma - 10) / 2 + character.proficiency
                      )
              ...
              <Grid item xs={3}>
                <h4>Stealth</h4>
                <p>
                  {proficiencies.includes("stealth")
                    ? Math.floor(
                        (character.dexterity - 10) / 2 + character.proficiency
                      )
                    : Math.floor((character.dexterity - 10) / 2)}
