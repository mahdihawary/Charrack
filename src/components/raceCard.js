    ...
    <div>
      <Accordion>
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography>{race.attributes.name}</Typography>
        </AccordionSummary>
        <AccordionDetails>
          ...
          <Typography>
            {asi()} {race.attributes.ability_score}.{" "}
          </Typography>
        </AccordionDetails>
...
const mdp = (dispatch) => {
  return {
    ...
    localSetRace: (race) => dispatch(setRace(race)),
    localSetSpeed: (speed) => dispatch(setSpeed(speed)),
    localVis: (vision) => dispatch(vis(vision)),
